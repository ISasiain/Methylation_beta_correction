...
#
#     * If the user has not selected to split the data on training and validation datasets;
#
...
#
#     * If the user has selected to split the data on training and validation datasets;
#
...
#     -N [TRUE/FALSE] -n [integer]
#     """
#     
#     *The function of the command line options are the following; 
#
#       -s: The user must especify if the purity and betas are in the same R object.
...
#If the user has selected to split the data in training and validation the following code will be run
...
# =================================================
# GETTING MOST VARIABLE CpGs BASED ON TRAINING DATA
# =================================================
...
if(arguments$get_only_CpGs_with_highest_variance) {
  ...
  cat("\n\nGetting CpGs with highest variance...\n")
  ...
  unadj_validation <- unadj_validation[sorting_vec,]
}
