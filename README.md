...
* MAIN SCRIPTS
    ...
    * **new_purity_corrector.r**. This script is an adaptation of the Staaf-Aine β correction method, that apart from correcting betas based on the mentioned method, it outputs the refernce regressions' parameters to be used by the purity estimation algorithm.

    * **purity_estimator.r**. This script estimates sample purity based only on beta values and the regression parameters of a reference data set generated by the previous script. 
