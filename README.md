...
* MAIN SCRIPTS
    ...
    * **final_beta_correction.r**. This script correct methylation β values of samples whose purity has been estimated using the previous script based on the Staaf-Aine method. This script allows to use directly the refernce regressions for the correction, or to refit them using the new datapoints (β values + estimated purity).
