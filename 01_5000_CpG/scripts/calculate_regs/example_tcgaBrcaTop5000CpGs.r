...
temp5 <- do.call("rbind",lapply(res,function(x) x$slopes)) #Slopes of the models
temp6 <- do.call("rbind",lapply(res,function(x) x$intercepts)) #Intercepts of the models

#Adding column names to temp4
colnames(temp4) <- colnames(temp1)
...
c1<-cutree( hclust( as.dist( 1-cor(temp1) ),method="ward.D"),5) #Clustering adjusted values
c2<-hclust( as.dist( 1-cor(temp1) ),method="ward.D") #Clustering rows to plot
c3<-cutree( hclust( as.dist( 1-cor(temp3) ),method="ward.D"),5) #Clustering unadjusted values
r1<-hclust( dist(temp1),method="ward.D") #Clustering columns to plot
...
my_colour = list(unadj5000=c("1"="#E41A1C","2"="#377EB8","3"="#4DAF4A","4"="#984EA3","5"="#FF7F00"),
    ...
    ER = c("[Not Available]"="#FFFF33", #Estrogen receptor
    ...
    PR = c("[Not Available]"="#FFFF33", #Progesterpne receptor
      "[Not Evaluated]"="#FF7F00",
      "Equivocal"="#377EB8",
      "Indeterminate"="#984EA3",
      "Negative"="#E41A1C",
    ...
    HER2 = c("[Not Available]"="#FFFF33", #Human epidermal growth factor receptor
      "[Not Evaluated]"="#FF7F00",
      "Equivocal"="#377EB8",
      "Indeterminate"="#984EA3",
      "Negative"="#E41A1C",
    ...
    TNBC = c("1"="black", #Triple negative breast cancer (YES/NO)
      "0"="lightgrey"),
    PAM50 = c("Basal"="#E41A1C", #PAM50 breast cancer molecular subtypes
      "LumB"="#377EB8",
      "LumA"="#4DAF4A",
      "Her2"="#984EA3",
      "Normal"="#808080",
